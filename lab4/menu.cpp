...
** Author:       Xiaoying Li
** Date:         7/21/2019
** Description:  The header file for startMenu() and endMenu() functions, 
...
bool startMenu()
{
    ...
    int startOption;
    cout << "Do you want to access OSU Information System?" << endl;
    cout << "Enter 1 if you want to access;" << endl;
...
bool endMenu()
{
    ...
    int endOption;
    cout << "Do you want to access OSU Information System again?" << endl;
    cout << "Enter 1 if you want to access again;" << endl;
    cout << "enter 0 if you want to quit." << endl;
